            ...
            <div class="card p-4 homepage">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        {{ csrf_field() }}
                        <h1>{{ env('APP_NAME', trans('global.app_name') ) }}</h1>
                        <p class="text-muted">{{ trans('form.login.login_title') }}</p>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                {{ trans('form.login.login') }}
                                </button>
                            </div>
                            <div class="col-4 text-right">
                                <a class="btn btn-link px-0" href="{{ route('password.request') }}">
                                {{ trans('form.login.forgot_password') }}
                                </a>
